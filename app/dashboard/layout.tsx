      ...
      {(user) => (
        <div className="min-h-screen bg-[#070b14] text-slate-100">
          <div aria-hidden="true" className="pointer-events-none fixed inset-0 overflow-hidden">
            ...
            <div className="absolute right-0 top-1/3 h-96 w-96 rounded-full bg-cyan-400/15 blur-3xl" />
          ...
          <div className="relative mx-auto flex w-full max-w-[1540px]">
            ...
            <div className="flex min-h-screen flex-1 flex-col">
              ...
              <footer className="border-t border-white/10 px-6 py-4 text-center text-xs text-slate-400 sm:px-8">
